...
def split(DAW, annotation_database, input_description):
    ...
    merge_task = Task("merge", "samtools_merge", [output_last_split_task], ["merged"], [], "merge", "SAMTOOLS_MERGE", module_path + "/SAMTOOLS.nf", input_description, {"channel_operators":[".collect()"]})
