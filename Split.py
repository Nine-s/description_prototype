...
def split(DAW, annotation_database, input_description):
    ...
    for alignment_task in alignment_tasks:
        ...
        median_input_size = 25#statistics.median(DAW.input.size_of_samples)
        ram = DAW.infra.RAM
        ...
        split_task = Task("split", "fastqsplit", [read_input_from_DAW], ["split_reads"], [], "split", ("FASTQSPLIT_" + alignment_task.tool.upper()),  module_path + "/FASTQSPLIT.nf", input_description, {"include_from": "FASTQSPLIT"}) 
